      ...
      <main className="max-w-[1320px] mx-auto px-6 py-8">
        ...
        <ScrollReveal direction="up">
          <div className="flex items-center gap-2 text-sm mb-6">
            ...
            <Link to="/category/tech-blog" className="text-category hover:underline">Tech Blog</Link>
            {slug && slug !== "tech-blog" && (
              <>
                <ChevronRight className="w-3 h-3 text-muted-foreground" />
        ...
        <ScrollReveal direction="scale" duration={0.9}>
          <Link to="/article" className="block mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
              {editorPicks.map((post, i) => (
                <ScrollReveal key={i} direction="up" delay={0.1 + i * 0.08}>
                  <Link to="/article" className="glass-panel rounded-xl p-2.5 pb-3 card-hover-glass group block">
            ...
            <div className="space-y-4">
              {recentPosts.map((post, i) => (
                <ScrollReveal key={i} direction="up" delay={0.05 + i * 0.04}>
                  <Link to="/article" className="flex gap-5 cursor-pointer group card-hover-glass rounded-xl p-3">
