    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-[1320px] mx-auto px-6 py-8">
        ...
        <ScrollReveal direction="scale" duration={0.9}>
          <Link to="/article" className="relative rounded-2xl overflow-hidden h-[380px] md:h-[440px] cursor-pointer group card-hover-glass mb-10 block">
              ...
              {timelineArticles.map((article, i) => (
                <ScrollReveal key={i} direction="up" delay={0.15 + i * 0.06}>
                  <div className="relative">
                    ...
                    <Link to="/article" className="flex gap-4 cursor-pointer group card-hover-glass rounded-xl p-3 -ml-2">
