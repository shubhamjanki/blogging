      ...
      <main className="max-w-[1320px] mx-auto px-6 py-8">
        ...
        <ScrollReveal direction="up">
          <div className="flex items-center gap-2 text-sm mb-6">
            <Link to="/" className="text-category hover:underline flex items-center gap-1"><ArrowLeft className="w-3.5 h-3.5" /> Home</Link>
            <ChevronRight className="w-3 h-3 text-muted-foreground" />
            <Link to="/category/resources" className="text-category hover:underline">Resources</Link>
            <ChevronRight className="w-3 h-3 text-muted-foreground" />
            <Link to="/category/ai-tools" className="text-category hover:underline">{resource.category}</Link>
            <ChevronRight className="w-3 h-3 text-muted-foreground" />
